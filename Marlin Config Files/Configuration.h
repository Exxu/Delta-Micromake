...
#define STRING_CONFIG_H_AUTHOR "(Richard, default config)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_MAX_RADIUS       95.0    // (mm)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.6 }
...
#define Z_PROBE_FEEDRATE_FAST (40*40)
...
#define HOMING_FEEDRATE_MM_M { (40*40), (40*40), (40*40) }
