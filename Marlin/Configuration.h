/**
 * https://www.youtube.com/watch?v=YUfFw8qlKfU&t=68s﻿/**
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 97.67
  #define  DEFAULT_bedKi 4.64
  #define  DEFAULT_bedKd 452.84
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 80 // mm
  ...
  #define DELTA_HEIGHT 310.68 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 95.08 //mm  Get this value from auto calibrate
...
#define E_MM_PER_ROTATION 11.647
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 200 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 300, 30 }
...
#define XY_PROBE_SPEED 1000 //4000
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, Z_MAX_POS }
